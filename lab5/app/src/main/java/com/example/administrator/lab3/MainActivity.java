...
public class MainActivity extends AppCompatActivity {
    ...
    mDynamicWidget mDynamicWidgetReceiver;
...
//        Boolean marktemp=false;
//        if(bundletemp!=null)
//        {
//            marktemp= bundletemp.getBoolean("toShoppingCar");
//            if(marktemp==true)
//            {
...
//        }
        /*发送动态Widget的过滤器*/
        mDynamicWidgetReceiver=new mDynamicWidget();
        registerReceiver(mDynamicWidgetReceiver,intentFilter);//注册接收器
...
//                    }
    ...
    protected void onDestroy()
    {
        ...
        unregisterReceiver(mDynamicWidgetReceiver);
